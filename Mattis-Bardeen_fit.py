...
#            MB_ok_ind_data.append(np.array(MB_ok_ind))
    ...
    def plot_Qi_Qc(self, var):
        ...
        plt.subplots_adjust(bottom=0.13, top=0.96, right=0.97, left=0.14)
        ...
        plt.yscale('log')
        plt.xlabel('Temperature [mK]', fontsize=42)
        plt.ylabel('Qi', fontsize=42)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        plt.ylim(min_Qi, max_Qi)
        plt.tick_params(axis='y', which='minor', labelsize=34)
        ...
        plt.subplots_adjust(bottom=0.14, top=0.95, right=0.97, left=0.12)
...
#        max_Qi = min([max([max(a) for a in qi_data])*1.05, max(med)*3])
        ...
        plt.xscale('log')
        plt.xlabel('Qi', fontsize=42)
        plt.ylabel('Number of resonances', fontsize=42)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        plt.legend([str(int(a[0]*1e3)) + ' mK' for a in T_data], fontsize=30)
        plt.xlim(min_Qi, max_Qi)
#        ax2.ticklabel_format(axis='x', style='sci', scilimits=(0,0))
        plt.tick_params(axis='x', which='minor', labelsize=34)
        ax2.tick_params(axis='both', which='both', pad=10)
        ...
        plt.yscale('log')
        plt.xlabel('Temperature [mK]', fontsize=42)
        plt.ylabel('Qc', fontsize=42)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        plt.ylim(min_Qc, max_Qc)
        plt.tick_params(axis='y', which='minor', labelsize=34)
        ax3.tick_params(axis='both', which='both', pad=5)
        plt.grid(True, which="both") 
        plt.show()
...
#        ax2.ticklabel_format(axis='x', style='sci', scilimits=(0,0))
        plt.tick_params(axis='x', which='minor', labelsize=34)
        ax4.tick_params(axis='both', which='both', pad=10)
        tx = ax2.xaxis.get_offset_text()
        tx.set_fontsize(34)
        plt.grid(True, which="both")     
        plt.show()
...
#            alphaQi, DeltaQi, Qi0 = xoptQi
    ...
    def plot_MBfit(self,var):
        ...
        plt.subplots_adjust(bottom=0.13, top=0.96, right=0.97, left=0.11)
        ...
        plt.xlabel('Temperature [mK]', fontsize=42, labelpad = 5)
        plt.ylabel(r'$\delta f_{res}(T) / f_{res}(0) \quad \times 10^3$ ', fontsize=42, labelpad = 10)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        ax10.tick_params(axis='both', which='both', pad=7)
        plt.grid()
        ...
        #plt.legend(str_leg, fontsize = 14, loc=3)
        plt.xlabel('Temperature [mK]', fontsize=42, labelpad = 5)
        plt.ylabel(r'$\delta \left[1/Qi(T)\right] \quad \times 10^5$ ', fontsize=42, labelpad = 10)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        ax20.tick_params(axis='both', which='both', pad=7)
        plt.grid()
        ...
        plt.subplots_adjust(bottom=0.14, top=0.96, right=0.97, left=0.11)
        ...
        plt.xlabel(r'Kinetic Inductance Fraction $\alpha$  ($f_{res}$ fit)', fontsize=42, labelpad = 10)
        plt.ylabel('Number of resonances', fontsize=42, labelpad = 10)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        ax11.tick_params(axis='both', which='both', pad=7)
        plt.legend([r'$\alpha$','Fit error [a.u.]'], fontsize = 30)
        plt.grid()
        ...
        plt.xlabel(r'Gap Energy $\Delta$ [meV]  ($f_{res}$ fit)', fontsize=42, labelpad = 10)
        plt.ylabel('Number of resonances', fontsize=42, labelpad = 10)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        ax12.tick_params(axis='both', which='both', pad=7)
        plt.legend([r'$\Delta$','Fit error [a.u.]'], fontsize = 30)
        plt.grid()
        ...
        plt.xlabel(r'Kinetic Inductance Fraction $\alpha$  ($Q_i$ fit)', fontsize=42, labelpad = 10)
        plt.ylabel('Number of resonances', fontsize=42, labelpad = 10)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        ax21.tick_params(axis='both', which='both', pad=7)
        plt.legend([r'$\alpha$','Fit error [a.u.]'], fontsize = 30)
        plt.grid()
        ...
        plt.xlabel(r'Gap Energy $\Delta$ [meV]  ($Q_i$ fit)', fontsize=42, labelpad = 10)
        plt.ylabel('Number of resonances', fontsize=42, labelpad = 10)
        plt.xticks(color='k', size=38)
        plt.yticks(color='k', size=38)
        ax22.tick_params(axis='both', which='both', pad=7)
        plt.legend([r'$\Delta$','Fit error [a.u.]'], fontsize = 30)
        plt.grid()
